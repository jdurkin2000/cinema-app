...
export default function LoginPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      // redirect by role
      router.push(data.role === "ADMIN" ? "/system-admin" : "/profile");
  ...
  return (
    <div className="p-8 max-w-md mx-auto">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        <input className="border p-2 w-full" placeholder="Email" type="email" required value={email} onChange={e => setEmail(e.target.value)} />
        <input className="border p-2 w-full" placeholder="Password" type="password" required value={password} onChange={e => setPassword(e.target.value)} />
