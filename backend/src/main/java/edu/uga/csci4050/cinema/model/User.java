...
public class User {
    ...
    // Per-user ticket history (embedded documents)
    ...
    public Instant getEmailVerifyExpiry() {
        return emailVerifyExpiry;
    }

    public void setEmailVerifyExpiry(Instant emailVerifyExpiry) {
